...
// Tue May 16 18:02:11 2023 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: root://cms-xrd-global.cern.ch//store/data/Run2022G/Muon/NANOAOD/PromptNanoAODv11_v1-v2/2820000/9f6bb4a5-0c8d-4c0d-9449-2c0d9abc6278.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Electron_cutBased_Fall17V2[6];   //[nElectron]
   ...
   Int_t           Electron_svIdx[6];   //[nElectron]
   ...
   Int_t           Electron_fsrPhotonIdx[6];   //[nElectron]
   ...
   Int_t           FsrPhoton_electronIdx[4];   //[nFsrPhoton]
   ...
   Int_t           Jet_nSVs[18];   //[nJet]
   Int_t           Jet_svIdx1[18];   //[nJet]
   Int_t           Jet_svIdx2[18];   //[nJet]
   ...
   Int_t           LowPtElectron_electronIdx[7];   //[nLowPtElectron]
   Int_t           LowPtElectron_pdgId[7];   //[nLowPtElectron]
   Int_t           LowPtElectron_photonIdx[7];   //[nLowPtElectron]
   ...
   Int_t           Photon_cutBased_Fall17V2[7];   //[nPhoton]
   ...
   Int_t           Proton_singleRP_decRPId[1];   //[nProton_singleRP]
   UInt_t          nSubJet;
   ...
   Int_t           Tau_eleIdx[5];   //[nTau]
   Int_t           Tau_jetIdx[5];   //[nTau]
   Int_t           Tau_muIdx[5];   //[nTau]
   Int_t           Tau_nSVs[5];   //[nTau]
   Int_t           Tau_svIdx1[5];   //[nTau]
   Int_t           Tau_svIdx2[5];   //[nTau]
   ...
   Float_t         TrigObj_l1pt[61];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[61];   //[nTrigObj]
   Float_t         TrigObj_l2pt[61];   //[nTrigObj]
   Int_t           TrigObj_id[61];   //[nTrigObj]
   Int_t           TrigObj_l1iso[61];   //[nTrigObj]
   Int_t           TrigObj_l1charge[61];   //[nTrigObj]
   Int_t           TrigObj_filterBits[61];   //[nTrigObj]
   UInt_t          nOtherPV;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      return;
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cms-xrd-global.cern.ch//store/data/Run2022G/Muon/NANOAOD/PromptNanoAODv11_v1-v2/2820000/9f6bb4a5-0c8d-4c0d-9449-2c0d9abc6278.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cms-xrd-global.cern.ch//store/data/Run2022G/Muon/NANOAOD/PromptNanoAODv11_v1-v2/2820000/9f6bb4a5-0c8d-4c0d-9449-2c0d9abc6278.root");
      }
